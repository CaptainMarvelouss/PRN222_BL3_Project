...
namespace PRN222_BL3_Project.Views.HomePage
{
    ...
    {
        private readonly IFieldService _locationService;
        //private readonly IEmailService _emailService;

        public List<Field> Fields { get; set; }
        public bool ShowWelcomeModal { get; set; }

        public IndexModel(IFieldService locationService, IEmailService emailService)
        {
        ...
        public async Task OnGetAsync(string culture = "en")
        {
            ...
            Fields = await _locationService.GetLocationsAsync();

            // Check if we should show the welcome modal
            // Could use cookies or session state to determine this
